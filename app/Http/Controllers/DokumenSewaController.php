...
class DokumenSewaController extends Controller
{
    public function dokumenSewa(Request $request)
    {
        ...
        $pdf = PDF::loadView('dokumen_sewa', ['order' => $order, 'detail' => $detail, 'order1' => $order1, 'detail1' => $detail1, 'detail_orders' => $detail_orders, 'kepala_uptd' =>$kepala_uptd, 'kepala_dinas' =>$kepala_dinas]);
